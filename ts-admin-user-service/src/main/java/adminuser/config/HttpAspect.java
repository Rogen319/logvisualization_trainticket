...
public class HttpAspect {
    ...
    @Pointcut("execution(public * adminuser.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * adminuser.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * adminuser.config.MockLog.printLog(..))")
