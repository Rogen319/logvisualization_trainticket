...
public class HttpAspect {
    ...
    @Pointcut("execution(public * adminbasic.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * adminbasic.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * adminbasic.config.MockLog.printLog(..))")
