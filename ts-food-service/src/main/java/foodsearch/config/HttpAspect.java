...
public class HttpAspect {
    ...
    @Pointcut("execution(public * foodsearch.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * foodsearch.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * foodsearch.config.MockLog.printLog(..))")
