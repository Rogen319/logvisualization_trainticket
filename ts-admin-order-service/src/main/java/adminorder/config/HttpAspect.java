...
public class HttpAspect {
    ...
    @Pointcut("execution(public * adminorder.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * adminorder.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * adminorder.config.MockLog.printLog(..))")
