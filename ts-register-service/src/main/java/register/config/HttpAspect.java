...
public class HttpAspect {
    ...
    @Pointcut("execution(public * register.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * register.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * register.config.MockLog.printLog(..))")
