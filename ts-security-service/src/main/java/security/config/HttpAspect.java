...
public class HttpAspect {
    ...
    @Pointcut("execution(public * security.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * security.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * security.config.MockLog.printLog(..))")
