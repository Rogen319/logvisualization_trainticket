...
public class HttpAspect {
    ...
    @Pointcut("execution(public * consign.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * consign.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * consign.config.MockLog.printLog(..))")
