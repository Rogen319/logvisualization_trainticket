...
public class HttpAspect {
    ...
    @Pointcut("execution(public * conf.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * conf.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * conf.config.MockLog.printLog(..))")
