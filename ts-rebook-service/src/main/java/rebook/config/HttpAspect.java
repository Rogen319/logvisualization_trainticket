...
public class HttpAspect {
    ...
    @Pointcut("execution(public * rebook.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * rebook.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * rebook.config.MockLog.printLog(..))")
