...
public class HttpAspect {
    ...
    @Pointcut("execution(public * preserveOther.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * preserveOther.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * preserveOther.config.MockLog.printLog(..))")
