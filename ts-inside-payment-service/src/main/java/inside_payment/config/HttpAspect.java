...
public class HttpAspect {
    ...
    @Pointcut("execution(public * inside_payment.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * inside_payment.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * inside_payment.config.MockLog.printLog(..))")
