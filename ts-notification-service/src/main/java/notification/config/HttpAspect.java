...
public class HttpAspect {
    ...
    @Pointcut("execution(public * notification.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * notification.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * notification.config.MockLog.printLog(..))")
