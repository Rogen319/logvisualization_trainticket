...
public class HttpAspect {
    ...
    @Pointcut("execution(public * other.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * other.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * other.config.MockLog.printLog(..))")
