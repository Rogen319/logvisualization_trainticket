...
public class HttpAspect {
    ...
    @Pointcut("execution(public * plan.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * plan.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * plan.config.MockLog.printLog(..))")
