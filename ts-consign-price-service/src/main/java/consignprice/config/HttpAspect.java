...
public class HttpAspect {
    ...
    @Pointcut("execution(public * consignprice.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * consignprice.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * consignprice.config.MockLog.printLog(..))")
