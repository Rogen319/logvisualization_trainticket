...
public class HttpAspect {
    ...
    @Pointcut("execution(public * food.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * food.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * food.config.MockLog.printLog(..))")
