...
public class HttpAspect {
    ...
    @Pointcut("execution(public * seat.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * seat.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * seat.config.MockLog.printLog(..))")
