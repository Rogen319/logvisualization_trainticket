...
public class HttpAspect {
    ...
    @Pointcut("execution(public * route.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * route.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * route.config.MockLog.printLog(..))")
