package com.trainticket.verificationcode.config;
...
public class HttpAspect {
    ...
    @Pointcut("execution(public * com.trainticket.verificationcode.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * com.trainticket.verificationcode.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * com.trainticket.verificationcode.config.MockLog.printLog(..))")
