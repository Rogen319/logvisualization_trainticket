...
public class HttpAspect {
    ...
    @Pointcut("execution(public * adminroute.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * adminroute.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * adminroute.config.MockLog.printLog(..))")
