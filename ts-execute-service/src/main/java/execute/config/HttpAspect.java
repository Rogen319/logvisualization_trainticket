...
public class HttpAspect {
    ...
    @Pointcut("execution(public * execute.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * execute.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * execute.config.MockLog.printLog(..))")
