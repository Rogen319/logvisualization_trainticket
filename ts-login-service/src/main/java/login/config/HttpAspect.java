...
public class HttpAspect {
    ...
    @Pointcut("execution(public * login.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * login.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * login.config.MockLog.printLog(..))")
