...
public class HttpAspect {
    ...
    @Pointcut("execution(public * cancel.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * cancel.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * cancel.config.MockLog.printLog(..))")
