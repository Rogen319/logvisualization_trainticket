...
//        );
    ...
    private ChangeOrderResult cancelFromOrder(ChangeOrderInfo info, HttpHeaders headers) {
        ...
        HttpEntity<ChangeOrderInfo> request = new HttpEntity<>(info, headers);
        ChangeOrderResult result = restTemplate.exchange("http://ts-order-service:12031/order/update",
                HttpMethod.POST, request, ChangeOrderResult.class).getBody();
        return result;
    }
