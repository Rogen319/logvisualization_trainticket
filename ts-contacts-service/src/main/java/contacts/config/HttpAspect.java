...
public class HttpAspect {
    ...
    @Pointcut("execution(public * contacts.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * contacts.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * contacts.config.MockLog.printLog(..))")
