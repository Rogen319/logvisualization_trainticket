...
public class HttpAspect {
    ...
    @Pointcut("execution(public * assurance.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * assurance.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * assurance.config.MockLog.printLog(..))")
