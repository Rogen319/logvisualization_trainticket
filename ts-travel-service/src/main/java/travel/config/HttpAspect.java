...
public class HttpAspect {
    ...
    @Pointcut("execution(public * travel.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * travel.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * travel.config.MockLog.printLog(..))")
