...
public class HttpAspect {
    ...
    @Pointcut("execution(public * price.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * price.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * price.config.MockLog.printLog(..))")
