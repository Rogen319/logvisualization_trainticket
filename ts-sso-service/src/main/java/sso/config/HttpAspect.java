...
public class HttpAspect {
    ...
    @Pointcut("execution(public * sso.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * sso.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * sso.config.MockLog.printLog(..))")
