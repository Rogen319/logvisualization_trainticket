...
public class HttpAspect {
    ...
    @Pointcut("execution(public * travelplan.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * travelplan.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * travelplan.config.MockLog.printLog(..))")
