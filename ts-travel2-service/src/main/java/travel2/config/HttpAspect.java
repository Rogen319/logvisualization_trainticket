...
public class HttpAspect {
    ...
    @Pointcut("execution(public * travel2.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * travel2.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * travel2.config.MockLog.printLog(..))")
