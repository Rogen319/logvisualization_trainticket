...
public class HttpAspect {
    ...
    @Pointcut("execution(public * fdse.microservice.controller.*.*(..))")
    public void webLog(){
    }
    ...
    @AfterThrowing(value = "execution(public * fdse.microservice.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * fdse.microservice.config.MockLog.printLog(..))")
